...
- **Location-based** — auto-detects your position, cached in localStorage for instant reload
- **Movement-aware** — uses watchPosition to silently detect location changes without re-prompting
...
- **Twilight info** — shows when twilight ends during dusk or last 30 minutes of daylight
